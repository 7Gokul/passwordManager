...
class App extends Component {
  ...
  deleteUserApplicationDetails = id => {
    ...
    const updateUserAppDetailsList = userAppsDetailsList.filter(
      each => each.id !== id,
    )
    this.setState({userAppsDetailsList: updateUserAppDetailsList})
  }
  ...
  render() {
    ...
    const filteredAppsList = userAppsDetailsList.filter(each =>
